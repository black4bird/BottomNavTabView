...
/**
 * com.xjx.xjxpartner.view.BottomTabView<br/>
...
public class BottomTabView extends LinearLayout {
  ...
  public BottomTabView(Context context, AttributeSet attrs) {
    super(context, attrs);
    TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.BottomTabView);
    internalPadding = ta.getDimensionPixelSize(R.styleable.BottomTabView_internal_padding, 0);
    imgWidth = ta.getDimensionPixelSize(R.styleable.BottomTabView_width_img, 0);
    imgHeight = ta.getDimensionPixelSize(R.styleable.BottomTabView_height_img, 0);
    textSize = ta.getDimension(R.styleable.BottomTabView_title_text_size, 0);
    groupPadding = ta.getDimensionPixelSize(R.styleable.BottomTabView_group_padding, 0);
    tabBg = ta.getResourceId(R.styleable.BottomTabView_tab_bg, 0);
    Log.i("CC", "internalPadding:" + internalPadding + ",imgWidth:" + imgWidth + ",imgHeight:" + imgHeight
        + ",groupPadding:" + groupPadding + ",textSize:" + textSize);
    init(context);
    ta.recycle();
  }
  ...
  class BottomTab extends RelativeLayout {
    ...
    int img_nor = R.drawable.ic_launcher, img_sel = R.drawable.ic_launcher, textColor_nor = R.color.black,
        textColor_sel = R.color.black, bg_nor = R.color.background, bg_sel = R.color.background;
    ...
    public BottomTab(Context context, String title, int img_nor, int img_sel, int textColor_nor, int textColor_sel,
        int bg_nor, int bg_sel) {
      super(context);
      this.img_nor = img_nor;
      this.img_sel = img_sel;
      this.textColor_nor = textColor_nor;
